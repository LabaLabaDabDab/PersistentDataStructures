...
{
    public interface IPersistentDictionary<TKey, TValue> : IPersistentDataStructure<KeyValuePair<TKey, TValue>, IPersistentDictionary<TKey, TValue>>, IImmutableDictionary<TKey, TValue>
    {
