...
{
    public interface IUndoRedoDictionary<TKey, TValue> : IPersistentDictionary<TKey, TValue>, IUndoRedoDataStructure<KeyValuePair<TKey, TValue>, IUndoRedoDictionary<TKey, TValue>>
    {
